...
export function navigate<T extends keyof RootStackParamList>(
    name: T,
    ...params: RootStackParamList[T] extends undefined ? [] : [RootStackParamList[T]]
) {
...
export function reset<T extends keyof RootStackParamList>(name: T, params?: RootStackParamList<T>) {
    if (navigationRef.isReady()) {
